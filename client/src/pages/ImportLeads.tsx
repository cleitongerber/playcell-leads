...
export default function ImportLeads() {
  ...
  const [useSpreadsheetPdv, setUseSpreadsheetPdv] = useState(false);
  ...
  const targetPdv = pdvs.find((pdv) => pdv.name === defaultStore);
  useEffect(() => {
