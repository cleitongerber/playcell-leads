...
const menuItems = [
  ...
  { icon: MapPin, label: "PDVs", path: "/pdvs", roles: ["admin"] },
  { icon: Megaphone, label: "Campanhas", path: "/campaigns", roles: ["admin"] },
  { icon: ScrollText, label: "Auditoria", path: "/audit", roles: ["admin"] },
];
